...
const ConfirmPopUp = ({ isOpen, onClose, onClick }) => {
      ...
      <ModalContent borderRadius={"2xl"}>
        ...
        <ModalBody className="mb-2 flex flex-col items-center justify-center">
          ...
          <h3 className="text-lg font-semibold first-letter:capitalize">
            {t("confirm-service.title")}
          </h3>
          <p className="text-sm">{t("confirm-service.description")}</p>
          ...
          <div className="mt-4 flex items-center space-x-2">
            ...
            <button
              ...
              onClick={onClick}
            >
              <p>{t("confirm-service.continue")}</p>
            </button>
          </div>
        </ModalBody>
      </ModalContent>
