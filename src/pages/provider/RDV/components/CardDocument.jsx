    ...
    return (
        ...
        >
            <div className="flex items-center space-x-3">
                ...
                <div>
                    <p className="text-sm first-letter:capitalize truncate w-[150px]">
                        {item.name}
                    </p>
            ...
            <button
                className={`border rounded-full border-gray-400 px-1 py-2 flex items-center space-x-1 ${
                    loading ? "bg-gray-50 opacity-50" : ""
                }`}
                disabled={loading}
                onClick={handleDownload}
            >
                <img src={icons.documentUpload} alt="" />
                <p className="text-xs first-letter:capitalize font-medium text-primary-100">
                    {t("list.download")}
                </p>
            </button>
        </div>
