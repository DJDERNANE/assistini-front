...
const CardService = ({ title, subTitle, items, selected, setSelected }) => {
  return (
    <div>
      ...
      <div className="bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] rounded-2xl mt-4 p-4 mr-10">
...
const Item = ({ title, description }) => {
  ...
  return (
    <div onClick={() => setSelected((s) => !s)}>
      <li className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-50 cursor-pointer">
        <div className="w-6 h-6 rounded-full bg-[#0AAF6050] flex items-center justify-center">
