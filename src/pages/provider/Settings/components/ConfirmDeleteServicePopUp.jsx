...
const ConfirmDeleteServicePopUp = ({ isOpen, onClose, onClick }) => {
            ...
            <ModalContent borderRadius={"2xl"}>
                ...
                <ModalBody className="mb-6 flex flex-col items-center justify-center">
                    ...
                    <h3 className="text-lg font-semibold first-letter:capitalize">
                        {t("confirm-delete-service.title")}
                    </h3>
                    <p className="text-sm">
                        {t("confirm-delete-service.description")}
                    </p>
                    ...
                    <div className="mt-4 flex items-center space-x-2">
                        <button
                            ...
                            onClick={onClose}
                        >
                            <p>{t("confirm-delete-service.cancel")}</p>
                        </button>
                        <button
                            ...
                            onClick={onClick}
                        >
                            <p>{t("confirm-delete-service.continue")}</p>
                        </button>
                    </div>
                </ModalBody>
            </ModalContent>
...
export default ConfirmDeleteServicePopUp;
